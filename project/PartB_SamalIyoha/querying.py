...
def execute_queries(uri, user, password, root_path):
    ...
    with driver.session() as session:
        def run_query_and_export_to_csv(query, csv_file_name, query_description, root_path):
            ...
            query_folder= os.path.join(root_path, "QUERY_RESULTS")
            if not os.path.exists(query_folder):
                os.makedirs(query_folder)

            csv_file_path = os.path.join(query_folder, f"{csv_file_name}.csv")
        ...
        # creating indexes for fatser querying
        ...
        run_query_and_export_to_csv(query_1, "query_1_top_3_cited_papers", query_1_description, root_path)
        ...
        run_query_and_export_to_csv(query_2, "query_2_authors_4_editions", query_2_description, root_path)
        ...
        run_query_and_export_to_csv(query_3, "query_3_impact_factor", query_3_description, root_path)
        ...
        run_query_and_export_to_csv(query_4, "query_4_h_index", query_4_description, root_path)
